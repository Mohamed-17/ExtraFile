...
export const HelpFoot = () => {
  return (
    ...
    <Link to={"/faqs"} className='container_img'><img src="https://media.extra.com/i/aurora/HelpSupport_Icon36" alt="" /></Link>
    ...
    <div className='d-flex flex-column'> 
    <Link to={"/trackorder"} className='container_img'><img src="https://media.extra.com/i/aurora/PackageTracking_Icon36" alt="" /></Link>
    ...
    <div className='d-flex flex-column'> 
    <Link to={"/returnexchange"} className='container_img'><img src="https://media.extra.com/i/aurora/Exchange_Icon36" alt="" /></Link>
    ...
    <div className='d-flex flex-column'> 
    <Link to={"/PMG"} className='container_img'><img src="https://media.extra.com/i/aurora/PMP_Icon36" alt="" /></Link>
    ...
    <div className='d-flex flex-column'> 
    <Link to={"/payment"} className='container_img'><img src="https://media.extra.com/i/aurora/Payment_Icon36" alt="" /></Link>
