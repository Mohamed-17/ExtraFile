...
export const Navbar = () => {
  ...
  return (
    ...
    <li>
        ...
        <div>
        <img src="https://cdn.extrastores.com/hybris/cdn/prod/202405121844/_ui/responsive/theme-extra-02/images/jood/jood-logo.svg" alt="" />
        </div>
        </Link>
    </li>
    ...
    <Link to={"/baseeta"} onClick={()=>{
      ...
      <li> <img src="https://cdn.extrastores.com/hybris/cdn/prod/202405121844/_ui/responsive/theme-extra-02/images/tasheel-icon.svg" alt="No image" /> <span>Baseeta</span></li>
    </Link>
    <div className="br"></div>
    ...
    <img src="https://cdn.extrastores.com/hybris/cdn/prod/202405121844/_ui/responsive/theme-extra-02/images/flag_sa.png" alt="" />
